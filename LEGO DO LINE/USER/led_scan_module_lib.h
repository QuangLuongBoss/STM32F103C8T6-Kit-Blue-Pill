...
#define LEDSCAN_PIN_OUT1		GPIO_Pin_7
#define LEDSCAN_PIN_OUT2		GPIO_Pin_6
#define LEDSCAN_PIN_OUT3		GPIO_Pin_5
#define LEDSCAN_PIN_OUT4		GPIO_Pin_4
#define LEDSCAN_PIN_OUT5		GPIO_Pin_8
#define LEDSCAN_OUT1				0x08
#define LEDSCAN_OUT2				0x04
#define LEDSCAN_OUT3				0x02
#define LEDSCAN_OUT4				0x01
